            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/laporan/replacement" title="Preview Replacement"><button class="btn btn-secondary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Preview</button></a>
                        <a href="/laporan/replacement/pdf" title="Print Replacement"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Print</button></a>
                        <br/>
                        <br/>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Nama Lengkap </th><td> {{ $replacement->nama_lengkap }} </td></tr><tr><th> Mata Kuliah </th><td> {{ $replacement->mata_kuliah }} </td></tr><tr><th> Kelas </th><td> {{ $replacement->kelas }} </td></tr>
                                </tbody>
                            </table>
                        </div>
