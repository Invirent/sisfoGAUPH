            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('admin/room' . '/' . $room->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Location Id </th><td> {{ $room->location_id }} </td></tr><tr><th> Room Number </th><td> {{ $room->room_number }} </td></tr>
                                </tbody>
                            </table>
                        </div>
